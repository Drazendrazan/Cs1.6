...
Scheme
{
	...
	Colors
	{
		...
		"DisabledText1"		"80 80 80 255"		// disabled text
		...
		"BorderSelection"		"0 0 0 64"	// the additional border color for displaying the default/selected button
		"BorderBuyPreset"		"0 0 0 64"	// the lit side of a control
