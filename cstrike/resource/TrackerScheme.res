...
//
// Black Theme, Vista Like, 
// Edited by: Anime4000
// Site: http://ianimegame.tk/
Scheme
{
	//////////////////////// COLORS ///////////////////////////
	Colors
	{
		...
		"DisabledText2"		"192 192 192 255"	// overlay color for disabled text (to give that inset look)
		"DimListText"		"117 134 102 255"	// offline friends, unsubscribed games, etc.

		// background colors
		"ControlBG"		"0 0 0 100"		// background color of controls
		"ControlDarkBG"		"0 0 0 100"		// darker background color; used for background of scrollbars
		"WindowBG"		"44 44 44 100"		// background color of text edit panes (chat, text entries, etc.)
		"SelectionBG"		"0 0 255 100"		// background color of any selected text or menu item
		"SelectionBG2"		"0 0 0 100"		// selection background in window w/o focus
		"ListBG"		"0 0 0 100"		// background of server browser, buddy list, etc.

		// titlebar colors
		"TitleText"		"255 255 255 100"
		"TitleDimText"		"136 145 128 100"
		"TitleBG"		"0 0 0 0"
		"TitleDimBG"		"0 0 0 0"
		...
		// border colors
		"BorderBright"		"100 100 100 200"	// the lit side of a control
		"BorderDark"		"60 60 60 210"		// the dark/unlit side of a control
		"BorderSelection"	"80 80 80 210"		// the additional border color for displaying the default/selected button
	}
